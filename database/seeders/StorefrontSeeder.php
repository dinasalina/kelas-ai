...
{
    /**
     * Categories with their products: name, description, price, emoji for the generated image.
     *
     * @var array<string, array<int, array{0: string, 1: string, 2: float, 3: string}>>
     */
    protected array $catalog = [
        'Makanan' => [
            ['Nasi Lemak Ayam Goreng', 'Nasi lemak berlaukkan ayam goreng rangup, sambal, telur dan kacang.', 9.50, '🍛'],
            ['Mee Goreng Mamak', 'Mee kuning digoreng bersama sayur, telur dan udang.', 7.00, '🍜'],
            ['Roti Canai Kosong', 'Roti canai rangup disajikan dengan kuah dhal dan sambal.', 2.20, '🫓'],
            ['Ayam Percik', 'Ayam panggang bersama kuah percik pedas manis khas pantai timur.', 12.00, '🍗'],
        ],
        'Minuman' => [
            ['Teh Tarik', 'Teh tarik panas berbuih, dibancuh secara tradisional.', 2.80, '🍵'],
            ['Air Bandung', 'Minuman sejuk sirap bandung bersama susu.', 3.00, '🥤'],
            ['Kopi O Ais', 'Kopi hitam ais tanpa susu, manis sederhana.', 2.50, '🧋'],
            ['Sirap Limau', 'Minuman sejuk sirap dan limau nipis segar.', 3.20, '🍹'],
        ],
        'Snek & Kuih' => [
            ['Kuih Lapis', 'Kuih tradisional berlapis warna-warni, lembut dan manis.', 1.50, '🍰'],
            ['Karipap Pusing', 'Pastri diisi kentang dan daging berperisa kari.', 1.20, '🥟'],
            ['Keropok Lekor', 'Keropok ikan goreng khas Terengganu, disajikan dengan cili.', 5.00, '🍤'],
            ['Cucur Udang', 'Cucur rangup berisi udang, disajikan dengan sos kacang.', 4.50, '🍢'],
        ],
    ];
    ...
    public function run(): void
    {
        ...
        foreach ($this->catalog as $categoryName => $products) {
            ...
            ])->each(fn (Order $order) => $this->seedStatusHistory($order, $staff));
    ...
    {
        $timestamp = now()->subMinutes(fake()->numberBetween(180, 2880));
